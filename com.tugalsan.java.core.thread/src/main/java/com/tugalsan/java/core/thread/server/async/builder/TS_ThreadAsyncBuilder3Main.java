...
public class TS_ThreadAsyncBuilder3Main<T> {
    ...
    protected TS_ThreadAsyncBuilder3Main(TS_ThreadSyncTrigger killTrigger, String name,
    ...
    public TS_ThreadAsyncBuilder4Fin<T> finEmpty() {
