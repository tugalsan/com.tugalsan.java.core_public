...
public class TS_SQLDistinctExecutor {

    final private static TS_Log d = TS_Log.of(TS_SQLDistinctExecutor.class);

    public TS_SQLDistinctExecutor(TS_SQLConnAnchor anchor, CharSequence tableName) {
        this.anchor = anchor;
