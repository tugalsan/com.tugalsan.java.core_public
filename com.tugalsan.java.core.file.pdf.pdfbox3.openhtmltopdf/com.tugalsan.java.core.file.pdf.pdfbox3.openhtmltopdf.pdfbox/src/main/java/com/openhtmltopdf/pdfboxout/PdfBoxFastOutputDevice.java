...
public class PdfBoxFastOutputDevice extends AbstractOutputDevice implements OutputDevice, PdfBoxOutputDevice {
    ...
    /**
     * Start a page. A new PDF page starts a new content stream so all graphics
     * state has to be set back to default.
     */
    @Override
    ...
    /**
     * We use paintBackground to do extra stuff such as processing links, forms
     * and form controls.
     */
    @Override
    ...
    /**
     * This returns a matrix that will convert y values to bottom up coordinate
     * space (as used by PDFs).
     */
    ...
    /**
     * Converts a top down unit to a bottom up PDF unit for the specified page
     * height.
     */
    @Override
