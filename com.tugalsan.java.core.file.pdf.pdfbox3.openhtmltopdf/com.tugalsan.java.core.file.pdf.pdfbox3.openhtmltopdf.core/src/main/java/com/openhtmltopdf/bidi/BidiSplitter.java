...
public interface BidiSplitter {
    ...
    /**
     * Count the number of runs, each of which contains text in one visual order
     * only. Can only be called after setParagraph has run the BIDI algorithm.
     */
    ...
    /**
     * Get the base direction of a paragraph. Defined as the first character
     * that has strong directionality or neutral if they are all neutral
     * characters.
     */
