...
public class TtfInstructionParser {
    ...
    public List<TtfInstruction> parse(byte[] data) throws IOException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static TtfInstruction createFromCode(int code)
        ...
        TtfInstruction instruction = (TtfInstruction) type.getDeclaredConstructor().newInstance();
        instruction.code = code;

        return instruction;
    }

    private static void initInstructionTypes() throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
