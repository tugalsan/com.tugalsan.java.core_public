...
public class PsType0ToOpenTypeConverter {
    ...
    public FVFont convert(PDType0Font type0Font) throws IOException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
    ...
    private OpenTypeFont getOtfFromDescendantFont(PDCIDFont descendantFont) throws IOException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (isTtfDescendant()) {
