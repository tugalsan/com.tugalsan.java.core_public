...
public class FontVerter {
    ...
    private static FVFont parseFont(byte[] fontData, Class<? extends FVFont> adapterOn) throws InstantiationException, IllegalAccessException, IOException, NoSuchMethodException, InvocationTargetException {
