...
/**
 * Maps input line to an HTML div rectangle, since HTML does not support
 * standard lines.
 */
public class HtmlDivLine {
    ...
    public float getTop() {
        ...
        } else // after rotation top left will be center of line so find the midpoint and correct for the line to border transform
        {
