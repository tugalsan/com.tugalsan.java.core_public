...
public class TGC_PopLblYesNoDateBoxExtraBtn4Status implements TGC_PopInterface {
    ...
    final private static TGC_Log d = TGC_Log.of(TGC_PopLblYesNoDateBoxExtraBtn4Status.class);
    ...
    public void setStatusHTML(String html) {
        lblStatus = TGS_NetworkHTMLUtils.HTML_SPACE() + html;
        status.setHTML(lblStatus);
    }
    private String lblStatus;

    public void reProcessStatus() {
        setStatusHTML(statusModifier.call(this));
    }
