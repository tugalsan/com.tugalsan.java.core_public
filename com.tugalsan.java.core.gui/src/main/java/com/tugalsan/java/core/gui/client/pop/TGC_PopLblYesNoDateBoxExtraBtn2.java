...
//        TGC_DOMUtils.setVisible(dateBox.getDatePicker().getElement(), visible);//TODO CAUSES A GLASS PANEL ON LEFT TOP
    ...
    final public void configFocus() {
        TGC_FocusUtils.addKeyUp(btnEsc, new TGS_FocusSides4(btnExe, btnExe, btnAdd1, dateBox.getTextBox()));
        TGC_FocusUtils.addKeyUp(btnExe, new TGS_FocusSides4(btnEsc, btnEsc, btnAdd2, dateBox.getTextBox()));
        TGC_FocusUtils.addKeyUp(dateBox.getTextBox(), new TGS_FocusSides4(null, null, btnEsc, btnAdd1));
        TGC_FocusUtils.addKeyUp(btnAdd1, new TGS_FocusSides4(btnAdd2, btnAdd2, dateBox.getTextBox(), btnEsc));
        TGC_FocusUtils.addKeyUp(btnAdd2, new TGS_FocusSides4(btnAdd1, btnAdd1, dateBox.getTextBox(), btnExe));
    }
