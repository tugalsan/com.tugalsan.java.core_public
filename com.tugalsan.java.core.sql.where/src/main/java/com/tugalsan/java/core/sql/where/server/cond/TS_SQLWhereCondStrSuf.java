...
public class TS_SQLWhereCondStrSuf extends TS_SQLWhereCondAbstract {

    public final static TS_Log d = TS_Log.of(TS_SQLWhereCondStrSuf.class);

    public TS_SQLWhereCondStrSuf(CharSequence columnName, CharSequence val) {
        super(columnName);
