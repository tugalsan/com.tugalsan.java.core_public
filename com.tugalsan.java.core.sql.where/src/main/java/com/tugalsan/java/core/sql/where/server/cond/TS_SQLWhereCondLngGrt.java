...
public class TS_SQLWhereCondLngGrt extends TS_SQLWhereCondAbstract {

    public final static TS_Log d = TS_Log.of(TS_SQLWhereCondLngGrt.class);

    public TS_SQLWhereCondLngGrt(CharSequence columnName, long val) {
        super(columnName);
        this.val = val;
    }
