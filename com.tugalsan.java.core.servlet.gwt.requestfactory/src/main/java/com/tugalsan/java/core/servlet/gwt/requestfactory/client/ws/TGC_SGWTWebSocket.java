...
public class TGC_SGWTWebSocket {
    ...
    private native void _open(TGC_SGWTWebSocket ws, String s, String url)/*-{
        ...
        $wnd[s].onopen = function() { ws.@com.tugalsan.java.core.servlet.gwt.requestfactory.client.ws.TGC_SGWTWebSocket::onOpen()(); };
        $wnd[s].onclose = function(evt) { ws.@com.tugalsan.java.core.servlet.gwt.requestfactory.client.ws.TGC_SGWTWebSocket::onClose(SLjava/lang/String;Z)(evt.code, evt.reason, evt.wasClean); };
        $wnd[s].onerror = function() { ws.@com.tugalsan.java.core.servlet.gwt.requestfactory.client.ws.TGC_SGWTWebSocket::onError()(); };
        $wnd[s].onmessage = function(msg) { ws.@com.tugalsan.java.core.servlet.gwt.requestfactory.client.ws.TGC_SGWTWebSocket::onMessage(Ljava/lang/String;)(msg.data); }
    }-*/;
